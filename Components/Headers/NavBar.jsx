...
export const NavBar = () => {
  return (
    <div className="w-full py-3 sm:py-0 sm:h-[6rem] flex items-center flex-row justify-between bg-white px-[1rem] lg:px-[4.2rem]">
      <div className="flex items-center flex-row gap-2 ">
        <span>
          <img src="Logos.png" alt="" />
        </span>
        <h1 className="font-[700] text-[1.5rem] sm:text-[2.125rem] text-[#000]">
          Furniro
        </h1>
      </div>
      <div className="hidden md:flex justify-center flex-row gap-5 lg:gap-[4.69rem]  mx-auto ">
        {NavLinks.map((value, index) => {
          ...
          return (
            <Link
              href={path}
              key={index}
              className="text-[#000000] font-[500] text-base capitalize"
            >
              {tab}
            </Link>
          );
      ...
      <div className="hidden sm:flex flex-row justify-center items-center gap-4 lg:gap-[3rem] ">
        {/* contacts icon */}
        <span>
          <svg
